...
function Patissier() {
    return (
        <section className="patissier-part px-[1rem] sm:px-[2rem] grid grid-cols-12 gap-4 mt-36">
            <div className="col-span-12 sm:col-span-6 order-last sm:order-first">
            ...
            <div className="col-span-12 sm:col-span-6 order-first sm:order-last relative">
                <div className="patissier-right-box px-4 py-[5rem] sm:py-[2rem] h-full rounded-xl">
                    <h1 className='text-white text-5xl w-48 uppercase m-0'>patissier PEINTRE ux ui ETC..</h1>
                ...
                <div className="patissier-right-box-bottom absolute bottom-6 right-6 flex items-center gap-3">
                    <div className="info">
                        <h5 className='text-white text-base font-semibold m-0'>N’HÉSITEZ PLUS !</h5>
                        <h6 className='text-white text-sm font-normal m-0'>Faites le test</h6>
                    </div>
                    <img
