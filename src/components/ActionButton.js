...
function ActionButton() {
    return (
        <div className="flex items-center justify-center py-10 sm:py-[10rem]">
            <a href="" className="flex flex-row gap-3 btn btn-secondary rounded-xl py-6 sm:px-10 w-2/3 sm:w-max hover:scale-105 hover:shadow-lg shadow-none">
                <p className="text-md">Commencer le test</p>
