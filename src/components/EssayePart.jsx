            ...
            <div className="col-span-12 sm:col-span-3 mt-1.5">
                <div className="essay-box-content relative">
                    ...
                    <div className="essay-content absolute bottom-4 left-0 px-3">
                        <h1 className='font-sans font-bold text-7xl text-white'>80%</h1>
                        <p className='font-sans text-white text-lg w-full sm:w-[75%] m-0 mt-4'>des personnes ayant changé de métier se disent plus satisfaites de leur travail après leur reconversion</p>
                    </div>
                </div>
            </div>
            <div className="col-span-12 sm:col-span-3 mt-1.5">
                <div className="essay-box-content relative">
                    ...
                    <img src={require("../images/essay-icon.png")} alt="" className='absolute top-10 right-10 w-7' />
                    <div className="essay-content absolute bottom-4 left-0 px-3">
                        <h1 className='font-sans font-bold text-7xl text-white'>50%</h1>
                        <p className='font-sans text-white text-lg w-full sm:w-[75%] m-0 mt-4'>des reconvertis ont vu une augmentation de leur salaire après avoir changé de métier</p>
                    </div>
                </div>
            </div>
            <div className="col-span-12 sm:col-span-3 mt-1.5">
                <div className="essay-box-content relative">
                    ...
                    <img src={require("../images/essay-icon.png")} alt="" className='absolute top-10 right-10 w-7' />
                    <div className="essay-content absolute bottom-4 left-0 px-3">
                        <h1 className='font-sans font-bold text-7xl text-white'>95%</h1>
                        <p className='font-sans text-white text-lg w-full sm:w-[75%] m-0 mt-4'>des reconvertis recommanderaient à d'autres de changer de métier pour suivre leur passion</p>
                    </div>
                </div>
            </div>
            <div className="col-span-12 sm:col-span-3 mt-1.5">
                <div className="essay-box-content relative">
                    ...
                    <img src={require("../images/essay-icon.png")} alt="" className='absolute top-10 right-10 w-7' />
                    <div className="essay-content absolute bottom-4 left-0 px-3">
                        <h1 className='font-sans font-bold text-7xl text-white'>60%</h1>
                        <p className='font-sans text-white text-lg w-full sm:w-[75%] m-0 mt-4'>des travailleurs ayant changé de carriére ont constaté une amélioration de leur équilibre travail-vie personnelle</p>
                    </div>
                </div>
            </div>
        </div>
